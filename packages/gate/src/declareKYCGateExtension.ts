...
import type { KYCGateExtensions, DeclareKYCGateOptions } from "./types.js";
  ...
  return {
    ...
    "kyc-gate": {
      ...
      onboarding: {
        ...
        body: {
          siwxHeader: "Base64-encoded SIWX (CAIP-122) payload JSON. Same format as the SIGN-IN-WITH-X header.",
        },
        response: {
